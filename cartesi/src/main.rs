...
struct AbundaceVerifier;

impl AbundaceVerifier {
    fn new() -> Self {
        Self
    }
}

impl Application for AbundaceVerifier {
    async fn advance(
        &self,
        ...
        let proof: TlsProof = serde_json::from_str(&String::from_utf8_lossy(payload)).unwrap();
